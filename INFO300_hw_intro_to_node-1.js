...
console.log(randomNumber);
 ...
 if (randomNumber < 26){
	...
	else if (randomNumber >= 26 && randomNumber <= 75) {
		console.log('It is a median number.');
	} 
	else {
...
var sales = readLineSync.questionInt('Project sales quantity');
var AP = readLineSync.questionInt('Average Price');
var Profit = sales * AP * .23
...
// any code in any other part of this file.                                    //
/// ///////////////////////////////////////////////////////////////////////////////
var sqft = readLineSync.questionInt('total number of square feet in a tract of land');
